...
//
// Upstream source: packages/injected/src/{domUtils,selectorUtils,roleUtils,roleSelectorEngine,injectedScript}.ts and
...
// `selectorUtils.ts`, `roleUtils.ts`, `roleSelectorEngine.ts` and the
// `internal:*` engines of `injectedScript.ts`, plus
// `packages/isomorphic/stringUtils.ts#normalizeWhiteSpace`.
//
