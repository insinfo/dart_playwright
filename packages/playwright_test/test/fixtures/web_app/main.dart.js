...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    explodeDeliberadamente() {
      throw A.wrapException(new A.StateError("boom vindo do Dart"));
    },
    main() {
      var t3,
        t1 = document,
      ...
      t3.id = "pronto";
      B.DivElement_methods.set$text(t3, "pronto");
      t2.appendChild(t3).toString;
      t1 = t1.querySelector("#estoura");
      t1.toString;
      t1 = J.get$onClick$x(t1);
      t3 = t1.$ti;
      A._EventStreamSubscription$(t1._target, t1._eventType, t3._eval$1("~(1)?")._as(new A.main_closure()), false, t3._precomputed1);
    },
